const configDes = [
  ...
  },
  {
    ...
    models: ["chuangmi.plug.m1", "chuangmi.plug.m2", "zimi.powerstrip.v2", "zimi.powerstrip.v1", "qmi.powerstrip.v1", "qmi.powerstrip.v2"],
  },
  {
    props: [
      {
  ...
  },
  {
    props: [
      ...
      { supportType: [1], prop_name: { zh_CN: "亮度调节", en: "Set bright" }, prop_key: "prop.bright", prop_unit: "%" },
  ...
  },
  {
    props: [
      ...
      },
      {
        ...
        prop_name: { en: "PM2.5", zh_HK: "PM2.5", zh_CN: "PM2.5", zh_TW: "PM2.5" },
        prop_extra: [
          { text_color: "#FF30C480", param_range: { min: 0, max: 35 }, desc: { en: "Excellent", zh_HK: "優", zh_CN: "优", zh_TW: "優" } },
          { text_color: "#FF76C430", param_range: { min: 36, max: 75 }, desc: { en: "Fine", zh_HK: "良", zh_CN: "良", zh_TW: "良" } },
          {
            text_color: "#FFE6BB25",
            param_range: { min: 76, max: 115 },
            desc: { en: "Light pollution", zh_HK: "輕度污染", zh_CN: "轻度污染", zh_TW: "輕度污染" },
      ...
      },
      {
        ...
        prop_unit: "℃",
        supportType: [1, 2],
        prop_name: { en: "Temperature", zh_HK: "溫度", zh_CN: "温度", zh_TW: "溫度" },
      },
      {
          ...
          operation: [
            {
              ...
              prop_value: "off",
              button_name: { en: "Power", zh_HK: "開關", zh_CN: "开关", zh_TW: "開關" },
              button_image: { selected: "title_btn_power_on", unable: "title_btn_power_unable", normal: "title_btn_power_off" },
            },
            {
              param: ["off"],
              method: "set_power",
        ...
        { cardType: 7, prop_key: "prop.humidity" },
        {
          ...
          operation: [
            ...
            },
            {
              ...
              button_image: { selected: "popup_icon_love_hig", unable: "popup_icon_love_unable", normal: "popup_icon_love_nor" },
              disable_status: [{ key: "prop.power", value: "off" }],
            },
          ],
          prop_key: "prop.mode",
  ...
  },
  {
    ...
    models: ["zhimi.humidifier.v1", "zhimi.humidifier.ca1", "zhimi.humidifier.ca2", "zhimi.humidifier.ca4", "zhimi.humidifier.cb1"],
  },
  {
    props: [
      {
  ...
  },
  {
    ...
    models: ["yunmi.waterpurifier.v3", "yunmi.waterpuri.lx2", "yunmi.waterpuri.lx4", "yunmi.waterpuri.lx3", "yunmi.waterpurifier.v2"],
  },
  {
    props: [
      {
