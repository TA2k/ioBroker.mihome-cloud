const configDes = [
        ...
        props: [
            {
                ...
                prop_extra: [
                    {
                        value: 'on',
                        desc: { en: 'On', zh_HK: '開', zh_CN: '开', zh_TW: '開' },
                    },
                    {
                        value: 'off',
                        desc: { en: 'Off', zh_HK: '關', zh_CN: '关', zh_TW: '關' },
                    },
                ],
            },
        ],
            ...
            card_items: [
                ...
                },
                {
                    ...
                    operation: [
                        {
                            method: 'set_volume',
                            disable_status: [{ key: 'prop.current_status', value: 'pause' }],
                        },
                    ],
                    prop_key: 'prop.current_volume',
        ...
        props: [
            {
                ...
                prop_extra: [
                    {
                        desc: { en: 'Close', zh_HK: '關閉', zh_CN: '关闭', zh_TW: '關閉' },
                        value: 'on',
                    },
                    {
                        desc: { en: 'Open', zh_HK: '打開', zh_CN: '打开', zh_TW: '打開' },
                        value: 'off',
                    },
                ],
                prop_name: { en: 'Power', zh_HK: '開關', zh_CN: '开关', zh_TW: '開關' },
    ...
    },
    {
        props: [
            ...
            },
            {
                ...
                prop_extra: [
                    {
                        desc: { zh_CN: '低温', en: 'Lower' },
                        param_range: { min: 16, max: 20 },
                    },
                    {
                        desc: { zh_CN: '室温', en: 'Normal' },
                        param_range: { min: 20, max: 26 },
                    },
                    {
                        desc: { zh_CN: '高温', en: 'High' },
                        param_range: { min: 26, max: 31 },
                    },
                ],
                format: '%.1f',
            },
    ...
    },
    {
        props: [
            ...
            { prop_key: 'prop.CCSet' },
            {
                ...
                format: '%.0f',
                prop_name: { zh_CN: '冷藏室', en: 'RCTemp' },
            },
            {
                prop_key: 'prop.CCSetTemp',
                format: '%.0f',
                prop_name: { zh_CN: '变温室', en: 'CCTemp' },
            },
            {
                prop_key: 'prop.FCSetTemp',
                format: '%.0f',
                prop_name: { zh_CN: '冷冻室', en: 'FCTemp' },
            },
        ],
        cards: {
            layout_type: 5,
            card_items: [
                {
                    ...
                    operation: [
                        {
                            method: 'setRCSetTemp',
                            disable_status: [{ key: 'prop.RCSet', value: 'off' }],
                        },
                    ],
                ...
                },
                {
                    ...
                    operation: [
                        {
                            method: 'setCCSetTemp',
                            disable_status: [{ key: 'prop.CCSet', value: 'off' }],
                        },
                    ],
    ...
    },
    {
        props: [
            ...
            {
                supportType: [1],
                prop_name: { zh_CN: '亮度调节', en: 'Set bright' },
                prop_key: 'prop.bright',
                prop_unit: '%',
            },
            {
                supportType: [1],
                prop_name: { zh_CN: '色温调节', en: 'Set cct' },
                prop_key: 'prop.cct',
            },
        ],
        cards: {
    ...
    },
    {
        ...
        models: [
            ...
            'zhimi.airpurifier.mb5',
            'zhimi.airpurifier.va1',
            'zhimi.airpurifier.va2',
    ...
    },
    {
        ...
        cards: {
            layout_type: 0,
            card_items: [{ supportGrid: 1, cardType: 7, prop_key: 'prop.aqi' }],
        },
    ...
    },
    {
        ...
        cards: {
            layout_type: 0,
            card_items: [{ supportGrid: 1, cardType: 7, prop_key: 'prop.setup_tempe' }],
        },
    ...
    },
    {
        ...
        cards: {
            layout_type: 0,
            card_items: [{ supportGrid: 1, cardType: 8, prop_key: 'event.alarm' }],
        },
    ...
    },
    {
        ...
        cards: {
            layout_type: 0,
            card_items: [{ supportGrid: 1, cardType: 8, prop_key: 'prop.leak' }],
        },
    ...
    },
    {
        props: [
            ...
            },
            {
                prop_key: 'prop.bright',
                supportType: [1, 2],
                prop_name: { zh_CN: '亮度', en: 'Brightness' },
                prop_unit: '%',
                prop_extra: [
                    { value: '1', desc: { zh_CN: '1%', en: '1%' } },
                    { value: '100', desc: { zh_CN: '100%', en: '100%' } },
                ],
            },
            {
                prop_key: 'prop.scene_num',
                supportType: [1, 2],
                prop_name: { zh_CN: '场景', en: 'Scene' },
                prop_extra: [
                    { value: '1', desc: { zh_CN: '儿童阅读', en: 'Child Reading' } },
                    { value: '2', desc: { zh_CN: '成人阅读', en: 'Adult Reading' } },
                    { value: '3', desc: { zh_CN: '电脑', en: 'Computer' } },
                    { value: '4', desc: { zh_CN: '场景4', en: 'Scene 4' } },
                ],
            },
            {
                prop_key: 'prop.dvalue',
                supportType: [1, 2],
                prop_name: { zh_CN: '延时关闭', en: 'Delay Off' },
                prop_unit: 'min',
                prop_extra: [
                    { value: '0', desc: { zh_CN: '0分钟', en: '0 min' } },
                    { value: '60', desc: { zh_CN: '60分钟', en: '60 min' } },
                ],
            },

            {
                prop_key: 'prop.notifystatus',
                supportType: [1, 2],
                switchStatus: ['on'],
                prop_name: { zh_CN: '疲劳提醒', en: 'Eye Fatigue Reminder' },
                prop_extra: [
                    { value: 'on', desc: { zh_CN: '开', en: 'On' } },
                    { value: 'off', desc: { zh_CN: '关', en: 'Off' } },
                ],
            ...
            {
                prop_key: 'prop.eyecare',
                supportType: [1, 2],
                switchStatus: ['on'],
                prop_name: { zh_CN: '护眼模式', en: 'Eyecare Mode' },
                prop_extra: [
                    { value: 'on', desc: { zh_CN: '开', en: 'On' } },
                    { value: 'off', desc: { zh_CN: '关', en: 'Off' } },
                ],
            ...
            {
                prop_key: 'prop.ambstatus',
                supportType: [1, 2],
                switchStatus: ['on'],
                prop_name: { zh_CN: '氛围灯开关', en: 'Ambient Light' },
                prop_extra: [
                    { value: 'on', desc: { zh_CN: '开', en: 'On' } },
                    { value: 'off', desc: { zh_CN: '关', en: 'Off' } },
                ],
            ...
            {
                prop_key: 'prop.ambvalue',
                supportType: [1, 2],
                prop_name: { zh_CN: '氛围灯亮度', en: 'Ambient Brightness' },
                prop_unit: '%',
                prop_extra: [
                    { value: '1', desc: { zh_CN: '1%', en: '1%' } },
                    { value: '100', desc: { zh_CN: '100%', en: '100%' } },
            ...
            },
            {
                ...
                supportType: [1, 2],
                switchStatus: ['on'],
                prop_name: { zh_CN: '智能夜灯', en: 'Smart Night Light' },
                prop_extra: [
                    { value: 'on', desc: { zh_CN: '开', en: 'On' } },
                    { value: 'off', desc: { zh_CN: '关', en: 'Off' } },
                ],
            ...
            card_items: [
                    ...
                    operation: [
                        {
                            ...
                            prop_value: 'off',
                            button_image: {
                                normal: 'http://cdn.cnbj0.fds.api.mi-img.com/miot-developer/63f78f4d3a1c9e9d16ffa60e4e0ff3a1.png',
                                press: 'http://cdn.cnbj0.fds.api.mi-img.com/miot-developer/f51ef0e14aef6ed05b02c9dd35ea58e9.png',
                            },
                            button_name: { zh_CN: '开灯', en: 'Turn On' },
                        },
                        {
                            param: ['off'],
                            method: 'set_power',
                            prop_value: 'on',
                            button_image: {
                                normal: 'http://cdn.cnbj0.fds.api.mi-img.com/miot-developer/f51ef0e14aef6ed05b02c9dd35ea58e9.png',
                                press: 'http://cdn.cnbj0.fds.api.mi-img.com/miot-developer/63f78f4d3a1c9e9d16ffa60e4e0ff3a1.png',
                            },
                            button_name: { zh_CN: '关灯', en: 'Turn Off' },
                        },
                    ],
                },
                {
                ...
                },
                {
                    ...
                    operation: [
                        {
                            param: ['1'],
                            method: 'set_user_scene',
                            prop_value: '1',
                            button_name: { zh_CN: '儿童阅读', en: 'Child Reading' },
                        },
                        {
                            param: ['2'],
                            method: 'set_user_scene',
                            prop_value: '2',
                            button_name: { zh_CN: '成人阅读', en: 'Adult Reading' },
                        },
                        {
                            param: ['3'],
                            method: 'set_user_scene',
                            prop_value: '3',
                            button_name: { zh_CN: '电脑', en: 'Computer' },
                        },
                        {
                            param: ['4'],
                            method: 'set_user_scene',
                            prop_value: '4',
                            button_name: { zh_CN: '场景4', en: 'Scene 4' },
                        },
                    ],
                },
                {
...

                {
                    ...
                    operation: [
                        {
                            param: ['on'],
                            method: 'set_notifyuser',
                            prop_value: 'off',
                            button_name: { zh_CN: '疲劳提醒开', en: 'Reminder On' },
                        },
                        {
                            param: ['off'],
                            method: 'set_notifyuser',
                            prop_value: 'on',
                            button_name: { zh_CN: '疲劳提醒关', en: 'Reminder Off' },
                        },
                    ],
                },
                {
                    ...
                    operation: [
                        {
                            ...
                            method: 'set_eyecare',
                            prop_value: 'off',
                            button_name: { zh_CN: '护眼模式开', en: 'Eyecare On' },
                        },
                        {
                            param: ['off'],
                            method: 'set_eyecare',
                            prop_value: 'on',
                            button_name: { zh_CN: '护眼模式关', en: 'Eyecare Off' },
                        },
                    ],
                },
                {
                    ...
                    operation: [
                        {
                            ...
                            method: 'enable_amb',
                            prop_value: 'off',
                            button_name: { zh_CN: '氛围灯开', en: 'Ambient On' },
                        },
                        {
                            param: ['off'],
                            method: 'enable_amb',
                            prop_value: 'on',
                            button_name: { zh_CN: '氛围灯关', en: 'Ambient Off' },
                        },
                    ],
                },
                {
                    ...
                    operation: [
                        {
                            ...
                            method: 'enable_bl',
                            prop_value: 'off',
                            button_name: { zh_CN: '智能夜灯开', en: 'Smart Night Light On' },
                        },
                        {
                            param: ['off'],
                            method: 'enable_bl',
                            prop_value: 'on',
                            button_name: { zh_CN: '智能夜灯关', en: 'Smart Night Light Off' },
                        },
                    ],
                },
            ],
        },
        models: ['philips.light.sread1', 'philips.light.sread2'],
    },
    {
        props: [
            {
    ...
    },
    {
        props: [
            {
                prop_key: 'prop.state',
                supportType: [1],
                prop_name: { en: 'Status', zh_CN: '当前状态' },
                prop_extra: [
                    { value: 2, desc: { en: 'Dormant', zh_CN: '休眠' } },
                    { value: 3, desc: { en: 'Wait instruction', zh_CN: '等待指令' } },
                    { value: 5, desc: { en: 'Sweeping', zh_CN: '清扫' } },
                    { value: 6, desc: { en: 'Return charging', zh_CN: '回充' } },
                    { value: 7, desc: { en: 'Remote control', zh_CN: '遥控中' } },
                    { value: 8, desc: { en: 'Charging in progress', zh_CN: '充电中' } },
                    { value: 9, desc: { en: 'Charging error', zh_CN: '充电报错' } },
                    { value: 10, desc: { en: 'Pause', zh_CN: '暂停' } },
                    { value: 11, desc: { en: 'Partial sweeping', zh_CN: '局部清扫' } },
                    { value: 12, desc: { en: 'Error', zh_CN: '报错' } },
                    { value: 14, desc: { en: 'Upgrading', zh_CN: '升级中' } },
                ],
            },
            {
                prop_key: 'prop.fan_power',
                supportType: [1],
                prop_name: { en: 'Fan Power', zh_CN: '风力' },
                prop_unit: '%',
            },
            {
                prop_key: 'prop.clean_time',
                supportType: [1],
                prop_name: { en: 'Clean Time', zh_CN: '清扫时间' },
                prop_unit: 'min',
                ratio: 0.016666667,
            },
            {
                prop_key: 'prop.clean_area',
                supportType: [1],
                prop_name: { en: 'Clean Area', zh_CN: '清扫面积' },
                prop_unit: 'm²',
                ratio: 0.000001,
            },
            {
                prop_key: 'prop.error_code',
                supportType: [1],
                prop_name: { en: 'Error Code', zh_CN: '错误代码' },
            },
            {
                prop_key: 'prop.map_present',
                supportType: [1],
                prop_name: { en: 'Map Present', zh_CN: '地图存在' },
            },
            {
                prop_key: 'prop.in_cleaning',
                supportType: [1],
                prop_name: { en: 'In Cleaning', zh_CN: '清扫中' },
            },
            {
                prop_key: 'prop.in_returning',
                supportType: [1],
                prop_name: { en: 'Returning', zh_CN: '返回中' },
            },
            {
                prop_key: 'prop.in_fresh_state',
                supportType: [1],
                prop_name: { en: 'In Fresh State', zh_CN: '新状态' },
            },
            {
                prop_key: 'prop.lab_status',
                supportType: [1],
                prop_name: { en: 'Lab Status', zh_CN: '实验室状态' },
            },
            {
                prop_key: 'prop.battery',
                supportType: [1],
                prop_name: { en: 'Battery', zh_CN: '电量' },
                prop_unit: '%',
            },
            {
                prop_key: 'prop.dnd_enabled',
                supportType: [1],
                prop_name: { en: 'Do Not Disturb', zh_CN: '勿扰模式' },
            },
            {
                prop_key: 'prop.msg_ver',
                supportType: [1],
                prop_name: { en: 'Message Version', zh_CN: '消息版本' },
            },
            {
                prop_key: 'prop.msg_seq',
                supportType: [1],
                prop_name: { en: 'Message Sequence', zh_CN: '消息序列' },
            },
            {
                prop_key: 'prop.water_box_status',
                supportType: [1],
                prop_name: { en: 'Water Box Status', zh_CN: '水箱状态' },
            },
            {
                prop_key: 'prop.lock_status',
                supportType: [1],
                prop_name: { en: 'Lock Status', zh_CN: '锁定状态' },
            },
            {
                prop_key: 'prop.is_locating',
                supportType: [1],
                prop_name: { en: 'Is Locating', zh_CN: '定位中' },
            },
            {
                prop_key: 'prop.map_status',
                supportType: [1],
                prop_name: { en: 'Map Status', zh_CN: '地图状态' },
            },
        ],
        cards: {
            layout_type: 3,
        ...
        models: [
            ...
            'dreame.vacuum.p2008',
            'dreame.vacuum.p2009',
            'roborock.sweeper.e2v2',
            'roborock.sweeper.e2v3',
            'roborock.sweeper.p5',
        ],
    },
    {
                    ...
                    operation: [
                        {
                            ...
                            button_image: {
                                selected: 'btn_alert_on',
                                unable: 'btn_alert_unable',
                                normal: 'btn_alert_off',
                            },
                        },
                        {
                            param: ['oning'],
                    ...
                    depend_formulas: [
                        {
                            prop_unit: 'ppb',
                            value: 'ppb',
                            formula: [{ type: '*', value: '203' }],
                            format: '%.0f',
                        },
                        {
                            prop_unit: 'ppm',
                            value: 'ppm',
                            formula: [{ type: '*', value: '0.203' }],
                            format: '%.3f',
                        },
    ...
    },
    {
        ...
        cards: {
            layout_type: 0,
            card_items: [{ supportGrid: 1, cardType: 7, prop_key: 'prop.temperature' }],
        },
        ...
        props: [
            {
                ...
                prop_extra: [
                    {
                        value: 'true',
                        desc: { en: 'Off', zh_HK: '关闭', zh_CN: '关闭', zh_TW: '关闭' },
                    },
                    {
                        value: 'false',
                        desc: { en: 'On', zh_HK: '打开', zh_CN: '打开', zh_TW: '打开' },
                    },
                ],
            },
            {
            ...
            card_items: [
                {
                    ...
                    operation: [
                        ...
                        {
                            button_name: { zh_CN: '烹饪中', en: 'running' },
                            method: 'set_cancel',
                            prop_value: 'running',
                        },
                    ],
        ...
        props: [
            {
                supportType: [1],
                prop_key: 'prop.state',
                prop_name: { zh_CN: '状态', en: 'State' },
            },
        ],
        cards: {
            layout_type: 0,
            card_items: [{ supportGrid: 1, cardType: 8, prop_key: 'prop.state' }],
        },
    ...
    },
    {
        ...
        models: ['zhimi.heater.za1', 'zhimi.heater.mc2', 'zhimi.heater.za2'],
    },
    {
        props: [
            {
    ...
    },
    {
        ...
        cards: {
            layout_type: 0,
            card_items: [{ supportGrid: 1, cardType: 8, prop_key: 'prop.status' }],
        },
    ...
    },
    {
        ...
        cards: {
            layout_type: 0,
            card_items: [{ supportGrid: 1, cardType: 8, prop_key: 'prop.work_status' }],
        },
    ...
    },
    {
        ...
        cards: {
            layout_type: 0,
            card_items: [{ supportGrid: 1, cardType: 8, prop_key: 'prop.run_status' }],
        },
    ...
    },
    {
        ...
        cards: {
            layout_type: 0,
            card_items: [{ cardType: 8, prop_key: 'prop.work_status' }],
        },
        models: ['viomi.health_pot.v1'],
    },
    {
        cards: {
            card_items: [{ cardType: 8, prop_key: 'prop.status_code' }],
            layout_type: 0,
        },
        ...
        props: [
            {
                prop_extra: [
                    {
                        desc: { en: 'Printer Initialization', zh_CN: '打印机初始化' },
                        value: 0,
                    },
                    ...
                    {
                        desc: { en: 'Initializing CISS', zh_CN: '连供系统初始化' },
                        value: 11000000,
                    },
                    ...
                    {
                        desc: { en: 'Firmware Upgrading', zh_CN: '固件升级中' },
                        value: 40600000,
                    },
                    {
                        desc: { en: 'Reset to Factory Default', zh_CN: '正在恢复出厂设置' },
                        value: 40800000,
                    },
                    { desc: { en: 'Powered Off', zh_CN: '打印机关机' }, value: 60000000 },
                    {
                        desc: { en: 'Pen Door Opened', zh_CN: '墨仓门开启' },
                        value: 70005002,
                    },
                    {
                        desc: { en: 'Carrier Locked', zh_CN: '打印头架锁定中' },
                        value: 70005103,
                    },
                    {
                        desc: { en: 'Carrier Locked', zh_CN: '打印头架锁定中' },
                    ...
                    {
                        desc: { en: 'Input Tray Error', zh_CN: '进纸托盘错误' },
                        value: 70005101,
                    },
                    ...
                    {
                        desc: { en: 'Print Head Missing', zh_CN: '打印头缺失' },
                        value: 70002007,
                    },
                    {
                        desc: { en: 'Print Head Missing', zh_CN: '打印头缺失' },
                    ...
                    {
                        desc: { en: 'Print Head Error', zh_CN: '打印头错误' },
                        value: 70002013,
                    },
                    {
                        desc: { en: 'Print Head Error', zh_CN: '打印头错误' },
                    ...
                    {
                        desc: { en: 'Memory Error', zh_CN: '打印机内存故障' },
                        value: 70005201,
                    },
                    {
                        desc: { en: 'Memory Error', zh_CN: '打印机内存故障' },
                    ...
                    {
                        desc: { en: 'Printer Error', zh_CN: '打印机故障' },
                        value: 70005301,
                    },
        ...
        props: [
            {
                ...
                prop_extra: [
                    {
                        value: 'on',
                        desc: { zh_CN: '开', en: 'On', zh_TW: '開', zh_HK: '開' },
                    },
                    {
                        value: 'off',
                        desc: { zh_CN: '关', en: 'Off', zh_TW: '關', zh_HK: '關' },
                    },
                ],
                switchStatus: ['on'],
            },
        ...
        props: [
            ...
            },
            {
                ...
                prop_extra: [
                    ...
                    {
                        value: '4',
                        desc: { en: 'Fruit & vegetable juice', zh_CN: '果蔬汁' },
                    },
        ...
        props: [
            {
                ...
                prop_extra: [
                    ...
                    {
                        value: '1',
                        desc: { en: 'Delay to shut down', zh_CN: '延迟关机中' },
                    },
                    { value: '2', desc: { en: 'On', zh_CN: '工作中' } },
                    { value: '3', desc: { en: 'Cleaning', zh_CN: '清洗' } },
                    {
                        value: '4',
                        desc: { desc: { en: 'Clean reset', zh_CN: '清洗复位' } },
                    },
                ],
            },
            {
    ...
    },
    {
        ...
        cards: {
            layout_type: 0,
            card_items: [{ supportGrid: 1, cardType: 10, prop_key: 'event.motion' }],
        },
    },
    {
        ...
        cards: {
            layout_type: 0,
            card_items: [{ supportGrid: 1, cardType: 8, prop_key: 'prop.open' }],
        },
    },
    {
        models: [
    ...
    {
        models: ['dmaker.fan.p5', 'dmaker.fan.p33', 'dmaker.fan.p39'],
        props: [
            {
                prop_key: 'prop.power',
                supportType: [1],
    ...
    },
    {
        ...
        cards: {
            layout_type: 0,
            card_items: [{ cardType: 8, prop_key: 'prop.printer_status' }],
        },
    },
];
