const configDes = [
  ...
  },
  {
    ...
    cards: {
      layout_type: 0,
      card_items: [
        { supportGrid: 1, cardType: 7, prop_key: "prop.setup_tempe" },
      ],
    },
  ...
  },
  {
    ...
    cards: {
      layout_type: 0,
      card_items: [
        { supportGrid: 1, cardType: 7, prop_key: "event.pure_water_record" },
      ],
    },
    models: [
          ...
          operation: [
            {
              ...
              button_image: {
                normal:
                  "http://cdn.cnbj0.fds.api.mi-img.com/miot-developer/63f78f4d3a1c9e9d16ffa60e4e0ff3a1.png",
                press:
                  "http://cdn.cnbj0.fds.api.mi-img.com/miot-developer/f51ef0e14aef6ed05b02c9dd35ea58e9.png",
              },
  ...
  },
  {
    ...
    models: [
      "roborock.vacuum.c1",
      "roborock.sweeper.c1v2",
      "roborock.sweeper.c1v3",
    ],
  },
  {
    props: [
          ...
          operation: [
            {
              ...
              disable_status: [
                { key: "prop.function_status", value: "running" },
              ],
            },
            {
              param: ["fastcook"],
  ...
  },
  {
    ...
    cards: {
      layout_type: 0,
      card_items: [
        { supportGrid: 1, cardType: 8, prop_key: "prop.printer_status" },
      ],
    },
  ...
  },
  {
    ...
    cards: {
      layout_type: 0,
      card_items: [
        { supportGrid: 1, cardType: 8, prop_key: "prop.work_status" },
      ],
    },
  ...
  },
  {
    ...
    cards: {
      layout_type: 0,
      card_items: [
        { supportGrid: 1, cardType: 8, prop_key: "prop.run_status" },
      ],
    },
